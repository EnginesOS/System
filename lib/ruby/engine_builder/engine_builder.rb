...
#require '/opt/engines/lib/ruby/system/SystemConfig.rb'
require 'rubygems'
require 'git'
require 'fileutils'
require 'json'
...
#    @workerPorts=Array.new
    @webPort=SystemConfig.default_webport
#    @vols=Array.new
    @first_build = true
...
#    @databases= Array.new
  ...
  def clone_repo
    begin
      ...
      g = Git.clone(@repoName, @build_name, :path => SystemConfig.DeploymentDir)
    rescue Exception=>e
      log_exception(e)
      return false
    end
