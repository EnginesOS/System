module ServiceManagement
  def disable_service(service_name)
   ...
   STDERR.puts("MOVING" +ContainerStateFiles.container_service_dir(service_name).to_s + ' to ' + ContainerStateFiles.container_disabled_service_dir(service_name).to_s )    
