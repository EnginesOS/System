 ...
 def remove_domain(params)
  ...
  def run_volume_builder(container,username)
    ...
    begin
      ...
      command = "docker run --name volbuilder --memory=2m -e fw_user=" + username + " -e data_gid=" + container.data_gid + "   --cidfile " +SysConfig.CidDir + "volbuilder.cid " + mapped_vols + " -t engines/volbuilder:" + SystemUtils.system_release + " /bin/sh /home/setup_vols.sh "
