...
# Configurations methods 
  ...
  def get_service_configurations_hashes(service_hash)
    ...
    def get_service_configuration(service_hash)
        test_result(send_request('get_service_configuration', service_hash))
      end
    ...
    def rm_service_configuration(config_hash)
      test_result(send_request('rm_service_configuration', config_hash))
    end
    
    def add_service_configuration(config_hash)
        test_result(send_request('add_service_configuration', config_hash))
      end
