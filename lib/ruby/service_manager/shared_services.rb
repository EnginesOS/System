module SharedServices
  ...
  def share_service_to_engine(shared_service_params)
    raise EnginesException.new(warn_hash("Cannot share non sharable service", service_hash)) unless SoftwareServiceDefinition.is_sharable?(shared_service_params[:existing_service])     
