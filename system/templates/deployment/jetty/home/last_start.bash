...
if test ! -f  /home/engines/run/subs_run
	then
		...
		touch /home/engines/run/subs_run			
	fi
	
	if test -f /home/engines/run/flags/post_install
		then
			touch /home/engines/run/post_install.done
  ...
  if test  ! -f /home/engines/run/volume_setup_complete
   then
   echo "Waiting for Volume setup to Complete "
 	while test ! -f /home/engines/run/volume_setup_complete
 	  do
 	  echo  "."
 		sleep 10
 	 done
...
if test -f /home/engines/scripts/install.bash 
	then
		if ! test ! -f /home/engines/run/setup_complete
			then
				bash /home/engines/scripts/install.bash > /var/log/setup.log
				touch  /home/engines/run/setup_complete
		fi
	fi
