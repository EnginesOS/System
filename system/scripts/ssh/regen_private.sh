#!/bin/sh
if test -f /home/engines/.ssh/system/console_access 
 then
...
cat /home/engines/.ssh/asystem/uthorized_keys.console_access /home/engines/.ssh/system/authorized_keys.system  > /home/engines/.ssh/authorized_keys
