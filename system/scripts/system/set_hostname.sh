...
echo $hostname.$domain_name | ssh  -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no -i /home/engines/.ssh/mgmt/set_hostname engines@control /opt/engines/bin/set_hostname.sh 
