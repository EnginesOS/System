...
# @return [true|false]
#test cd /opt/engines/tests/engines_api/system/system_status ;  make  first_run_required
...
#test cd /opt/engines/tests/engines_api/system/system_status ;  make  status
