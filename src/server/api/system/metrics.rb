...
# test cd /opt/engines/tests/engines_tool/system/metrics ; make memory
...
# test cd /opt/engines/tests/engines_tool/system/metrics ; make load
...
# test cd /opt/engines/tests/engines_tool/system/metrics ; make mem_stats
...
# test cd /opt/engines/tests/engines_tool/system/metrics ; make disk
...
# @return [Hash] :tx :rx
# test cd /opt/engines/tests/engines_tool/system/metrics ; make network
